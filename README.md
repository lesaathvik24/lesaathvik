...
Somewhere along the way I noticed the tools I use all day are optimized to do the thinking for me, and that this was quietly working. I could review anything and build nothing. So some of what I make now pushes in the other direction.
